...
void Application::Init()
{
	...
	m_texture = new Texture();
	m_texture->Init("..\\Data\\Textures\\preview0.tga", GL_CLAMP_TO_EDGE, GL_LINEAR_MIPMAP_LINEAR);

	m_Button = new Sprite2D(m_model, m_Shaders, m_texture);
	m_Button->Set2DPosition(944, 368);
	m_Button->SetSize(672, 704);
	m_Button->Init();
